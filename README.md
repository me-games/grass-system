...
> Upstream: https://github.com/achrefelouafi/GrassSystemThreeJS
> Author: mohamedachrefelouafi · License: MIT · Ported from commit `b236b2a`
> Changes: build glue only (Genex embed-SDK boot + this notice). The two bundled demo GLBs (Rusty Car / Porsche 911, ~25MB) are not shipped — the bundled-model dropdown is hidden; "Import GLB…" with your own model still works. All credit for the code and idea goes to the original author.
